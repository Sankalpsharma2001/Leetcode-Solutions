...
public:
   int n,mod=1e9+7;
    ...
    int find(int i, string &s)
    {
        ...
        //we can't start with 0, ie 04,06 all are invalide
        //return 0 means we can't reach to last by this way
        ...
        */
        ...
        else if(s[i]=='2')
        {
            ...
            else if(i+1<n && s[i+1]<='6') c+=find(i+2,s); c%=mod;
        }
